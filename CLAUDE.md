...
> 🔴 **当前待办（2026-09-15）：代码侧仍有开放项，不是只剩真机验证。** 先看
> [docs/08 A7/A8](docs/08-代码审计报告.md)：A7-2/A7-3/A7-4/A7-6/A7-7 是待修的内存/可维护性项，
> A7-5 仍需逐行复核，A8-6 是 catalog 行级 user 否决缺口；A8-2~A8-5 是文档漂移。
> 真机验证 C-16~C-39 的唯一清单仍在 [docs/14 §21.2](docs/14-交接与待办清单.md)，
> 不要把代码待办和真机验证混为一谈。
