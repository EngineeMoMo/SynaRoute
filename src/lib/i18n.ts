...
const zh: Dict = {
  ...
  "editor.oneMHint": "窗口 ≥ 1000000 时自动启用 1M 上下文（转发时补 anthropic-beta 头），Claude Code / CLI 与桌面端均生效",
...
const en: Dict = {
  ...
  "editor.oneMHint": "A window ≥ 1000000 enables 1M context automatically (an anthropic-beta header is added when forwarding); applies to Claude Code / CLI and the desktop app",
