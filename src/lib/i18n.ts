...
const en: Dict = {
  ...
  "logs.type.system": "System",
  "logs.type.balance": "Balance",
  ...
  "settings.mcpWizardCodexHookText":
    "For complex code review, architecture design, or tricky debugging, call the synaroute_ai tool first to get a synthesized analysis from multiple models before acting.",
  "settings.mcpWizardClaudeHookMatcher": "review|refactor|audit",
  "settings.mcpWizardClaudeHookPrompt": "Call synaroute_ai first for a multi-model analysis",
  "settings.mcpWizardClaude": "Claude Code",
