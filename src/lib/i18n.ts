...
const zh: Dict = {
  ...
  "usage.title": "用量统计",
  "usage.subtitle": "按分类与 Key 聚合的 token 消耗（仅统计非流式调用；Claude/Codex 默认流式，其用量暂不采集）",
  "usage.refresh": "刷新",
  "usage.loading": "加载中…",
  "usage.empty": "暂无用量记录（仅统计非流式调用；Claude/Codex 默认流式，其用量暂不采集。可改用聚合或多模型等非流式调用查看）",
  "usage.input": "输入",
  "usage.output": "输出",
...
const en: Dict = {
  ...
  "usage.title": "Usage",
  "usage.subtitle": "Token consumption by category and key (non-streaming calls only; Claude/Codex stream by default, their usage isn't captured yet)",
  "usage.refresh": "Refresh",
  "usage.loading": "Loading…",
  "usage.empty": "No usage yet (non-streaming calls only; Claude/Codex stream by default, their usage isn't captured yet)",
  "usage.input": "Input",
  "usage.output": "Output",
