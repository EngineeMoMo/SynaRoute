...
const zh: Dict = {
  ...
  "usage.title": "用量统计",
  "usage.subtitle": "按分类与 Key 聚合的 token 消耗（本次运行累计，重启归零；仅统计 token，不换算金额）",
  "usage.refresh": "刷新",
  "usage.loading": "加载中…",
...
const en: Dict = {
  ...
  "usage.title": "Usage",
  "usage.subtitle": "Token consumption by category and key (since app start, resets on restart; token counts only, not cost)",
